...
impl<'a> SharkError<'a> {
    pub fn new(kind: SharkErrorKind, position: Range<SourcePosition<'a>>, message: &'a str, help: Option<&'a str>) -> Self {
        Self {
            kind,
            position,
            message,
    ...
    pub fn get_header(&self) -> String {
         format!("{} : \x1b[38;2;255;255;255m{}\x1b[0m\n found at: {}\n\n\n\n\n", self.kind.prefix(), self.message, self.position.start.stringify())
    }
